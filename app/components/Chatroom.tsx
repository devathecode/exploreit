    ...
    return (
        <>
            {showLoader ? <div>loading...</div> : <>
                {messages && <main className="border-t border-gray-50 relative h-screen px-2 bg-gray-100">
                    <div className="absolute right-0 top-0 w-full bg-white">
                        {messages[1] ? (
                            <div className="flex flex-row p-2">
                                <img
                                    src={messages[1].photoURL}
                                    alt="Avatar"
                                ...
                                <div className="my-auto">
                                    <p className="text-gray-600 ms-2">{messages[1].displayName}</p>
                                </div>
                            </div>
                        ) : null}
                    </div>
                    <ul className="overflow-scroll max-h-[94vh]">
